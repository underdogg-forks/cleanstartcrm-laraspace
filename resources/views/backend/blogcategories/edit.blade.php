...
@section('content')
    {{ Form::model($blogcategory, ['route' => ['admincp.blogCategories.update', $blogcategory], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-role']) }}
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    {{ link_to_route('admincp.blogCategories.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
