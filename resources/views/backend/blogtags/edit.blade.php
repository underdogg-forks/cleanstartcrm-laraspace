...
@section('content')
    {{ Form::model($blogtag, ['route' => ['admincp.blogTags.update', $blogtag], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-blogtags']) }}
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    {{ link_to_route('admincp.blogTags.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
