...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admincp.faqs.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.faqs.all')}}</a></li>
    @permission('create-faq')
    <li><a href="{{route('admincp.faqs.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.faqs.create')}}</a></li>
    @endauth
  </ul>
</div>
