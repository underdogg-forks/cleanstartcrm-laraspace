...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admincp.access.user.index')}}"><i class="fa fa-list-ul"></i> List</a></li>
    @permission('create-user')
    <li><a href="{{route('admincp.access.user.create')}}"><i class="fa fa-plus"></i> Add new</a></li>
    @endauth
    @permission('view-deactive-user')
    <li><a href="{{route('admincp.access.user.deactivated')}}"><i class="fa fa-square"></i> Deactivated Users</a></li>
    @endauth
    @permission('view-deleted-user')
    <li><a href="{{route('admincp.access.user.deleted')}}"><i class="fa fa-trash"></i> Deleted Users</a></li>
    @endauth
  </ul>
</div>